...
> This project was developed with significant contributions from [Chad Bojelador](https://github.com/ChadBojelador), who helped build and implement a major part of the application.
...
Learn how to create, read, update, and delete data in a full-stack environment — from fetching and displaying data to updating its values or deleting it.
